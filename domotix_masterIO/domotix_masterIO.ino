...
char  g_tempdaymin_string[20]; /* 27�C � 17h32 */
char  g_tempdaymax_string[20];
char  g_tempyearmin_string[30]; /* 27�C � 17h32 le 23/03 */
...
char  g_anemo_max_year_string[30]; /* 132 km/h � 17h32 le 23/03*/
...
void setup(void)
{
    ...
    sprintf(g_tempyearmin_string,"%d�C le %02d/%02d � %02dh%02d ",g_temperature_yearmin, g_temperature_yearmin_day, g_temperature_yearmin_mon, g_temperature_yearmin_hour, g_temperature_yearmin_min);
    ...
    sprintf(g_tempyearmax_string,"%d�C le %02d/%02d � %02dh%02d",g_temperature_yearmax, g_temperature_yearmax_day, g_temperature_yearmax_mon, g_temperature_yearmax_hour, g_temperature_yearmax_min);
    ...
    sprintf(g_anemo_max_year_string,"%d.%d km/h le %02d/%02d � %02dh%02d",
...
void process_domotix(void)
{
	...
	{
	    g_temperature_daymin = g_temperature_ext;
	    sprintf(g_tempdaymin_string,"%d�C � %02dh%02d",g_temperature_daymin ,g_hour, g_min);
	}

	if (g_temperature_ext >= g_temperature_daymax)
	{
	    g_temperature_daymax = g_temperature_ext;
	    sprintf(g_tempdaymax_string,"%d�C � %02dh%02d",g_temperature_daymax ,g_hour, g_min);
	}

	if (g_temperature_ext <= g_temperature_yearmin)
	{
	    g_temperature_yearmin = g_temperature_ext;
	    sprintf(g_tempyearmin_string,"%d�C le %02d/%02d � %02dh%02d",g_temperature_yearmin, g_day, g_mon, g_hour, g_min);
	...
	if (g_temperature_ext >= g_temperature_yearmax)
	{
	    ...
	    sprintf(g_tempyearmax_string,"%d�C le %02d/%02d � %02dh%02d", g_temperature_yearmax, g_day, g_mon ,g_hour, g_min);
...
void process_domotix_quick(void)
{
	...
	if ((msec - g_beginWait10sec) >= 10000)
	{
		...
		sprintf(g_anemo_max_day_string,"%d.%d km/h le %02d/%02d � %02dh%02d",
